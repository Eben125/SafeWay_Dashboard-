...
export const SENSOR_TABS = [
  ...
  { id: 'thermal_camera', name: 'Thermal Camera (LWIR)', icon: Flame, tag: '30–50 m', color: 'rose' },
  { id: 'mmwave_radar', name: '77 GHz mmWave Radar', icon: Radio, tag: '100–200 m', color: 'sky' },
  { id: 'lidar_3d', name: '1550 nm 3D LiDAR', icon: Box, tag: '50–100 m', color: 'emerald' },
  { id: 'uwb_rf', name: 'UWB / RF Transceiver', icon: Wifi, tag: 'V2V NLOS', color: 'indigo' },
  { id: 'rtk_gnss_imu', name: 'RTK-GNSS + IMU', icon: Compass, tag: 'Centimeter', color: 'amber' },
];

export default function NavigationTabs({ activeTab, onTabChange, volumes = {} }) {
  return (
    <div className="border-b border-slate-200 bg-white/50 backdrop-blur-sm sticky top-[65px] z-30 px-4 lg:px-8">
